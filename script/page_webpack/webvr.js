...
!function(A) {
      ...
      (function(I) {
         ...
         function(i) {
            ...
            var p = function(A, g, t, e, C) {
                  if (A._events = d(f, A._events || {}, g, t, {
                     context: e,
                     ctx: A,
                     listening: C
                  }), C) {
            ...
            D.started = !1, o(D.prototype, l, {
               ...
               navigate: function(A, g) {
                  ...
                  if (A = this.decodeFragment(A.replace(G, "")), this.fragment !== A) {
                     if (this.fragment = A, this._usePushState) this.history[g.replace ? "replaceState" : "pushState"]({}, document.title, e);
                     else {
         ...
         var C = t(3),
            ...
            i = g.extend({}, g.Events, {
               ...
               toDot: function(A) {
                  ...
                  e.kill(this.root), e.to(this.root.position, C, {
                     z: t,
                     ease: e.Quad.InOut
                  })
               }
         ...
         A.exports = g.extend({}, g.Events, {
            ...
            muteOn: function() {
               this.$muteOn.css({
                  ...
                  display: "block"
               }), this.isMute = !1, this.trigger("muteOn")
            },
            muteOff: function() {
               this.$muteOn.css({
                  display: "block"
                  ...
                  display: "none"
               }), this.isMute = !0, this.trigger("muteOff")
            },
            "in": function() {
            ...
            out: function() {
               this.close(), C.isVR ? this.$open.css({
                  display: "none"
               }) : this.$open.css({
                  display: "none"
               })
            ...
            vrOff: function() {
               C.isVR = !0, this.close(), this.$vrOn.css({
                  display: "block"
               }), this.$open.css({
                  display: "none"
               }), this.trigger("vr")
         ...
         A.exports = g.extend({}, g.Events, {
                     ...
                     t.css({
                        ...
                        C.css({
                           ...
                           I.css({
                              ...
                              opacity: Math.random()
                           }), A.$intro.on("touchstart", function() {
                              A.introOff()
                           })
                        })
                     })
            ...
            introOff: function() {
               this.$intro.find(".t5").css({
                  ...
                  display: "none"
               }), this.$intro.off("touchstart"), this.isIntro = !1, this.trigger("introOff")
            },
            tipOn: function(A) {
               ...
               this.$el.css({
                  ...
                  e.to(g.$bg, .3, {
                     ...
                     opacity: 0,
                     onEnd: function() {
                        this.target.style.display = "none", g.$el.css({
                           display: "none"
                        })
                     }
                  })
            ...
            popOff: function() {
               if (this.isPop) {
                  ...
                  e.to(this.$bg, .3, {
                     ...
                     opacity: 0,
                     onEnd: function() {
                        this.target.style.display = "none", A.$el.css({
                           display: "none"
                        }), A.$info.css({
                           backgroundImage: ""
                        }), A.isPop = !1
         ...
         var C = t(3),
            ...
            i = g.extend({}, g.Events, {
               ...
               complete: function() {
                  ...
                  g.position.set(0, 0, 0), this.addScene({
                     scene: g,
                     max: 2400,
                     min: -12e3
                  });
                  var t = this.createScene(this.data.data2);
                  t.position.set(0, 0, 1500), this.addScene({
                     scene: t,
                     max: 2400,
                     min: -12e3
                  });
                  var e = this.createScene(this.data.data3);
                  e.position.set(0, 0, 4500), this.addScene({
                     scene: e,
                     max: 2400,
                     min: -12e3
                  });
                  ...
                  I.position.set(0, 0, 7200), this.addScene({
                     scene: I,
                     max: -4900,
                     min: -29650
                  });
                  var i = this.createScene(this.data.data5);
                  i.position.set(0, 0, 8500), this.addScene({
                     scene: i,
                     max: -7e3,
                     min: -29650
                  });
                  var n = this.createScene(this.data.data6);
                  n.position.set(0, 0, 11e3), this.addScene({
                     scene: n,
                     max: -11e3,
                     min: -29650
                  });
                  var o = this.createScene(this.data.data7);
                  o.position.set(0, 0, 18e3), this.addScene({
                     scene: o,
                     max: -15500,
                     min: -29650
                  });
                  ...
                  s.position.set(0, 0, 3e4), this.addScene({
                     scene: s,
                     max: -29650,
                     min: -43600
                  });
                  var c = this.createScene(this.data.data9);
                  c.position.set(0, 0, 31e3), this.addScene({
                     scene: c,
                     max: -36e3,
                     min: -6e4
                  });
                  ...
                  l.position.set(0, 300, 5e3), h.add(l), this.addScene({
                     scene: h,
                     max: -42e3,
                     min: -6e4
                  });
                  var u = this.createScene(this.data.data11);
                  u.position.set(0, 0, 56e3), this.addScene({
                     scene: u,
                     max: -42e3,
                     min: -5e5
                  });
                  var d = this.createScene(this.data.data12);
                  d.position.set(0, 0, 61e3), this.addScene({
                     scene: d,
                     max: -29650,
                     min: -5e5
                  });
               ...
               createParticles: function(A, g, t, e, C, I) {
                  for (var i = new THREE.Group, n = [], o = 0, a = A.length; o < a; o++) n[o] = new THREE.SpriteMaterial({
   ...
   37: function(A, g) {
      ...
      THREE.SpriteCanvasMaterial = function(A) {
         THREE.Material.call(this), this.type = "SpriteCanvasMaterial", this.color = new THREE.Color(16777215), this.program = function(A, g) {}, this.setValues(A)
         ...
         void 0 === _.setLineDash && (_.setLineDash = function() {}), this.domElement = P, this.autoClear = !0, this.sortObjects = !0, this.sortElements = !0, this.info = {
            render: {
               vertices: 0,
               faces: 0
            }
         ...
         }, this.setScissor = function() {}, this.setScissorTest = function() {}, this.setClearColor = function(A, g) {
         ...
         }, this.clearColor = function() {}, this.clearDepth = function() {}, this.clearStencil = function() {}, this.render = function(A, t) {
            ...
            for (var i = 0, n = m.length; i < n; i++) {
               ...
               if (void 0 !== a && 0 !== a.opacity) {
                  if (dA.makeEmpty(), o instanceof THREE.RenderableSprite) M = o, M.x *= N, M.y *= W, e(M, o, a);
                  else if (o instanceof THREE.RenderableLine) M = o.v1, x = o.v2, M.positionScreen.x *= N, M.positionScreen.y *= W, x.positionScreen.x *= N, x.positionScreen.y *= W, dA.setFromPoints([M.positionScreen, x.positionScreen]), lA.intersectsBox(dA) === !0 && C(M, x, o, a);
               ...
               if (P.setObject(x), p = x.matrixWorld, r = 0, x instanceof THREE.Mesh) {
                  if (R instanceof THREE.BufferGeometry) {
                     ...
                     if (null !== R.index) {
                        ...
                        else for (var O = 0, U = N.length; O < U; O += 3) P.pushTriangle(N[O], N[O + 1], N[O + 2])
                  ...
                  if (R instanceof THREE.BufferGeometry) {
                     ...
                     if (void 0 !== B.position) {
                        for (var D = B.position.array, O = 0, U = D.length; O < U; O += 3) P.pushVertex(D[O], D[O + 1], D[O + 2]);
                        if (null !== R.index) for (var N = R.index.array, O = 0, U = N.length; O < U; O += 2) P.pushLine(N[O], N[O + 1]);
